...
namespace Coflow.iMotionsPlugin.Vive
{
    ...
    public class NtpClient : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NtpClient"/> class with the default NTP server address.
        /// </summary>
        public NtpClient()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NtpClient"/> class with the specified NTP server address.
        /// </summary>
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="NtpClient"/> class and optionally disposes of the managed resources.
        /// </summary>
        ...
        /// <summary>
        /// Releases all resources used by the current instance of the <see cref="NtpClient"/> class.
        /// </summary>
        public void Dispose()
        {
