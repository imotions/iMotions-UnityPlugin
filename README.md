...
2. Import this plugin via Git or Unity Package Manager.
   - **VIVE OpenXR Plugin** (included installer as an editor script)
   - Run the installer through the menu: "VIVE/OpenXR Installer/Install or Update latest version"
   - **AVPro Movie Capture** (Free Trial allowed and included in the package)

## 🧰 Usage

1. Add the plugin to your Unity project.
2. Ensure your project is configured for VIVE OpenXR.
3. Drag the "iMotions-Systems-Vive" prefab from the package/Runtime/Prefabs to your scene.
